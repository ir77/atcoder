...
fn main() {
    ...
    // exercise
    let n_deg: f64 = (((n % 12) as f64 / 12.0) + (m / 60.0 / 12.0)) * 360.0;
    let m_deg: f64 = m / 60.0 * 360.0;
    // if n_deg - m_deg > 180.0 {
    //     println!("{}", 360.0 - (n_deg - m_deg));
    // } else if n_deg - m_deg > 0.0 {
    //     println!("{}", n_deg - m_deg);
    // } else if n_deg - m_deg > -180.0 {
    //     println!("{}", m_deg - n_deg);
    // } else {
    //     println!("{}", 360.0 - (m_deg - n_deg));
    // }
    println!("{}", (n_deg - m_deg).abs().min(360.0 - (m_deg - n_deg).abs()))
}
