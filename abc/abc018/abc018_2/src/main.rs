...
fn main() {
    ...
    for i in 0..n {
        ...
        let first = &answer[0..l-1];
        let second = &answer[l-1..r].chars().rev().collect::<String>();
        let third = &answer[r..answer.len()];
        let first_second = first.to_string() + second;
        let first_second_third = first_second + third;
