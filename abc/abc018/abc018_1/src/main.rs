...
fn main() {
    ...
    // exercise
    println!("{}", get_rank(a, b, c));
    println!("{}", get_rank(b, a, c));
    println!("{}", get_rank(c, a, b));
}

fn get_rank(target: i64, other1: i64, other2: i64) -> i64 {
    return if target > other1 && target > other2 {
        1
    } else if target < other1 && target < other2 {
        3
    } else {
        2
    }
