...
fn main() {
    ...
    // exercise
    let mut accessory = "".to_string();
    for i in 0..n {
        if i == 0 {
            accessory = "b".to_string();
        } else if i % 3 == 0 {
            accessory = "b".to_string() + accessory.as_str() + "b";
        } else if i % 3 == 1 {
            accessory = "a".to_string() + accessory.as_str() + "c";
        } else {
            accessory = "c".to_string() + accessory.as_str() + "a";
        }
