...
fn main() {
    ...
    // exercise
    println!("{} {} {} {} {} {}",
             s.iter().map(|&x|x).filter(|&x| x == 'A').collect::<Vec<char>>().len(),
             s.iter().map(|&x|x).filter(|&x| x == 'B').collect::<Vec<char>>().len(),
             s.iter().map(|&x|x).filter(|&x| x == 'C').collect::<Vec<char>>().len(),
             s.iter().map(|&x|x).filter(|&x| x == 'D').collect::<Vec<char>>().len(),
             s.iter().map(|&x|x).filter(|&x| x == 'E').collect::<Vec<char>>().len(),
             s.iter().map(|&x|x).filter(|&x| x == 'F').collect::<Vec<char>>().len()
    );
}
