...
fn main() {
    ...
    let string3 = get_string_input();
    let string4 = get_string_input();

    // exercise
    // result
    println!("{}", string4.chars().rev().collect::<String>());
    println!("{}", string3.chars().rev().collect::<String>());
    println!("{}", string2.chars().rev().collect::<String>());
    println!("{}", string1.chars().rev().collect::<String>());
}
